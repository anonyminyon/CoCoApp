...
//using COCOApp.DAO;
//using COCOApp.DAO.API;
//using COCOApp.DAO.Casso.Transaction;
...
//    public ScheduleService(IHttpClientFactory clientFactory, IConfiguration config, StoreManagerContext context, ILogger<ScheduleService> logger, TransactionDAO transactionDao, BookingContractDAO bookingContractDao, ITransactionService transactionService)
//    {
//        _config = config;
